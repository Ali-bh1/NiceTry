...
/**
 * RippleGrid — WebGL-powered animated grid background with ripple effects.
 *
 * Uses OGL (lightweight WebGL library) to render a shader-based grid with:
 * - Center-outward ripple animation
 * - Optional mouse interaction for localized ripples
 * - Optional rainbow color cycling
 * - Vignette + fade distance for soft edge blending
 *
 * @see https://www.reactbits.dev/backgrounds/ripple-grid
 */
const RippleGrid = ({
  enableRainbow = false,
  gridColor = '#ffffff',
  ...
  /* ── Prop hot-update (no remount needed) ────────── */
  useEffect(() => {
